import { calculateTax } from '../src/engine/calculator';
import { TaxpayerProfile } from '../src/types';
...
describe('Tax Calculator', () => {
    ...
    test('should calculate tax correctly for 10L income (Old Regime)', () => {
        const result = calculateTax(baseProfile);
    ...
    test('should calculate tax correctly for 10L income (New Regime)', () => {
        const result = calculateTax(baseProfile);
